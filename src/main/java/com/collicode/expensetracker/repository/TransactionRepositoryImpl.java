...
public class TransactionRepositoryImpl implements TransactionRepository{
    ...
    public void update(Integer userId, Integer categoryId, Integer transactionId, Transaction transaction) throws EtBadRequestException {
        try {
            jdbcTemplate.update(SQL_UPDATE,new Object[]{transaction.getAmount(),transaction.getNote(),transaction.getTransactionDate(),transactionId,userId,categoryId});
        }catch (Exception e){
    ...
    public void removeById(Integer userId, Integer categoryId, Integer transactionId) throws EtResourceNotFoundException {
        ...
        int count =    jdbcTemplate.update(SQL_DELETE,new Object[]{userId,transactionId,categoryId});
        if (count==0){
            throw  new EtResourceNotFoundException("Transaction not found");
